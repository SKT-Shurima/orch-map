...
```typescript
// packages/mapData/src/managers/JapanPathManager.ts
...
```typescript
// packages/mapData/src/managers/PathManagerFactory.ts
...
```typescript
import { MapDataPathManager } from '@orch-map/mapData';
...
```typescript
import { PathManagerFactory, MapVersion } from '@orch-map/mapData';
