...
__export(index_exports, {
  ...
  DeckGLMapRenderer: () => DeckGLMapRenderer,
  DeckglMapAdapter: () => DeckglMapAdapter,
  EChartsMapRenderer: () => EChartsMapRenderer,
  EVENT_TYPES: () => EVENT_TYPES,
  EchartsMap: () => EchartsMap,
  MAP_RENDERER_TYPES: () => MAP_RENDERER_TYPES,
  MapRendererFactory: () => MapRendererFactory,
  MapRendererType: () => MapRendererType,
  RENDER_MODES: () => RENDER_MODES,
  UnifiedMapComponent: () => UnifiedMapComponent,
  createDeckglMap: () => createDeckglMap,
  createEchartsMap: () => createEchartsMap,
  createMapRenderer: () => createMapRenderer,
  createUnifiedMap: () => createUnifiedMap
});
      ...
      this.glMap = new GlMap(
        ...
        async () => {
          ...
          const geoJsonData = await MapStateManager.getGeoJsonData({
            mapLevel: import_types.MapLevel.WORLD,
            country: this.config.country ?? "100000",
            region: this.config.adcode ?? "100000"
          });
