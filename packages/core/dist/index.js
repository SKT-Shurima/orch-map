...
var GeoLayer = class {
   ...
   */
  static create() {
    return new import_layers.GeoJsonLayer({
...
var TextLayer = class {
  ...
  static createLayer(textData) {
    const color = (0, import_utils2.hexToRgba)(POINT_DEFAULT_STYLE.color);
    return new import_layers2.TextLayer({
      id: "label-layer",
      data: textData,
      characterSet: "auto",
      fontSettings: {
...
var _Line2DManager = class _Line2DManager {
  ...
  static buildFullCurveLayer(lines) {
    ...
    return new import_layers4.PathLayer({
      id: "line-layer",
      data: fullData,
      pickable: false,
      widthScale: 1,
  ...
  static buildMovingDotsLayer(lines, progress, options) {
    ...
    return new import_layers4.ScatterplotLayer({
      id: "line-trail-layer",
      data: dots,
      pickable: false,
      radiusUnits: "pixels",
...
var _Line3DManager = class _Line3DManager {
  ...
  static createLayers(lines, config = {}, currentTime = 0) {
    ...
    const baseLayer = new import_layers5.ArcTripsLayer({
      id: "arc-base-layer",
      data: routes,
    ...
    const trailLayer = new import_layers5.ArcTripsLayer({
      id: "arc-trail-layer",
      data: routes,
      getSourcePosition: (d) => d.sourcePosition,
      getTargetPosition: (d) => d.targetPosition,
