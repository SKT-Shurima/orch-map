...
// src/main.ts
import { MapLevel as MapLevel8 } from "@orch-map/types";
...
var _DeckglMap = class _DeckglMap {
  ...
  async createDeckInstance(container, initialViewState, props) {
    ...
    const mapView = new MapView({
      repeat: MapStateManager.curLevel === MapLevel4.WORLD,
      controller: {
        scrollZoom: true,
        dragPan: true,
        dragRotate: true,
...
var _GeoComponent = class _GeoComponent {
  ...
  static needsProjectionTransform() {
    if (MapStateManager.curLevel === MapLevel5.COUNTRY && MapStateManager.postcode === US_AD_CODE_JUST_FOR_FE) {
      return false;
    }
    return true;
  }
...
import { MapLevel as MapLevel32 } from "@orch-map/types";
import { MapLevel as MapLevel6 } from "@orch-map/types";
import { MapLevel as MapLevel22 } from "@orch-map/types";
...
var MapLevelUtils = class {
  ...
  static mapLevelMatrix(level) {
    switch (level) {
      case MapLevel7.COUNTRY:
        return 1;
      case MapLevel7.PROVINCE:
        return 2;
      case MapLevel7.CITY:
        return 3;
      case MapLevel7.COUNTY:
        return 4;
      case MapLevel7.WORLD:
      default:
        return 0;
    }
  }
  ...
  static levelNumToLevel(level) {
    switch (level) {
      case 1:
        return MapLevel7.COUNTRY;
      case 2:
        return MapLevel7.PROVINCE;
      case 3:
        return MapLevel7.CITY;
      case 4:
        return MapLevel7.COUNTY;
      default:
        return MapLevel7.WORLD;
    }
  }
  /**
  ...
  static isNextLevelSupported(nextLevel) {
    if (MapStateManager.curLevel === MapLevel7.COUNTRY && nextLevel === MapLevel7.PROVINCE) {
...
var OrchMap = class {
  ...
  async returnToWorldMap() {
    return this.navigateToLevel(MapLevel8.WORLD);
  }
